...
function corsidigrafica_main_content_bootstrap_classes() {
  if ( is_page_template( 'corsi-online.php' ) || is_page_template( 'storia.php' ) ||
    is_page_template( 'register.php' ) || is_page_template( 'page-fullwidth.php' ) || is_page_template( 'assumimi.php' ) ||
    is_page_template( 'gadget.php' ) || is_page_template( 'libri.php' ) ||
    is_page_template( 'content-full-eng-video.php' ) || is_page_template( 'il-facile-membership.php' )   ) { 
...
remove_action( 'admin_print_styles', 'print_emoji_styles' );
  ...
  function corsidigrafica_scripts() { 
    ...
    //wp_enqueue_style( 'corsidigrafica-style', get_template_directory_uri().'/assets/css/style.css' );
    ...
    // wp_enqueue_script('cookie',  get_template_directory_uri().'/assets/js/mailchimp.js', array('jquery') );
    ...
    // wp_enqueue_script('cookie',  get_template_directory_uri().'/assets/js/cookies.js', array('jquery') );
