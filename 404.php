			...
			<div class="post-inner-content">
				...
				<section class="error-404 not-found">
					<header class="page-header">
						<h1 class="page-title"><?php esc_html_e( 'Oops! questa pagina non esiste.', 'corsidigrafica' ); ?></h1>
					</header><!-- .page-header -->

					<div class="page-content">
						<p><?php esc_html_e( 'Che ne dici di provare con una ricerca?', 'corsidigrafica' ); ?></p>

						<?php get_search_form(); ?>

						<div class="row">
							<div class="col-md-6 not-found-widget">
								<?php the_widget( 'WP_Widget_Recent_Posts', 'title='.esc_html__( 'Articoli recenti', 'corsidigrafica' ) ); ?>
							</div>
<!-- 
							<div class="col-md-6 not-found-widget">
