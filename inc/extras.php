 ...
 * @return void
 */
function corsidigrafica_setup_author() {
  global $wp_query;
...
add_action( 'wp', 'corsidigrafica_setup_author' );
...
function custom_password_form() {
  ...
  <div class="row">
    <div class="col-lg-10">
        ' . esc_html__( "Questo articolo è protetto da password. Iscriviti alla newsletter gratuita per visualizzare immediatamente il video di illustrator di 60 minuti." ,'sparkling') . '
      ...
      <div class="input-group">
        ...
        <span class="input-group-btn"><button type="submit" class="btn btn-default" name="submit" id="searchsubmit" value="' . esc_attr__( "Submit",'sparkling' ) . '">' . esc_html__( "Invia" ,'sparkling') . '</button>
        </span>
      </div>
    </div>
  </div>
